  ...
  return (
    <nav className="glass-card rounded-none md:rounded-2xl md:mx-4 md:mt-4 px-6 py-4 mb-6 sticky top-0 z-50">
      <div className="flex justify-between items-center">
        {/* Logo */}
        <Link to="/home" className="flex items-center gap-1.5 sm:gap-2 group shrink-0">
          <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-primary-400 to-primary-600 rounded-lg sm:rounded-xl flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-neon group-hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] transition-all">
            CF
          </div>
          <span className="text-base sm:text-lg font-bold text-heading hidden xs:block">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-lg sm:rounded-xl flex items-center justify-center text-white font-bold text-xs sm:text-sm hover:shadow-neon transition-all"
            >
